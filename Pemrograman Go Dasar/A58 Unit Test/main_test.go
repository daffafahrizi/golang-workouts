...
func TestHitungVolume(t *testing.T) {
	...
	if kubus.Volume() != volumeSeharusnya {
		t.Errorf("Volume seharusnya %.2f", volumeSeharusnya)
	}
}
...
func TestHitungLuas(t *testing.T) {
	...
	if kubus.Luas() != luasSeharusnya {
		t.Errorf("Luas seharusnya %.2f", luasSeharusnya)
	}
}

func TestHitungKeli(t *testing.T) {
	t.Logf("Keliling: %.2f", kubus.Keliling())
	if kubus.Keliling() != kelilingSeharusnya {
		t.Errorf("Keliling seharusnya %.2f", kelilingSeharusnya)
	}
}
